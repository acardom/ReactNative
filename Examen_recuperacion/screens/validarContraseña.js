...
export default function RegisterScreen({ navigation }) {
  ...
  const handleRegister = async (values) => {
    try {
        ...
        const storedcontraseña = await AsyncStorage.getItem('contraseña'); // Obtiene el correo almacenado

      if (values.contraseña === storedcontraseña) {
        Alert.alert('Éxito', 'Registro exitoso'); // Muestra una alerta de éxito
        navigation.navigate('inicio'); // Navega a la siguiente pantalla
      } else {
